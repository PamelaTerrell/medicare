...
concern:
  ...
  "Some ads can sound or look official even when they come from a private insurer, broker, agency, marketing company, or lead generator.",
...
questions: [
  ...
  "Does the setting make a private sales offer look like a government benefits program?",
...
if (looksGovernmental === "yes") {

results.push({

  title: "Government-like visual staging",

  text:

    "The commercial may use a benefits line, official-looking counter, waiting area, paperwork, seal, colors, or actors portrayed as benefit workers to make a private insurance offer look governmental. Identify the advertiser and verify whether the telephone number belongs to a government agency, an insurer, or a lead-generation service.",
...
const [looksGovernmental, setLooksGovernmental] = useState("not-sure");
...
if (looksGovernmental === "yes") {
  ...
  questions.push("Is this actually connected to Medicare, Social Security, a state agency, or any government program?");

  questions.push("Who paid for the commercial and who answers the advertised telephone number?");

  questions.push("Is the caller selling insurance or collecting my information for other agents?");
...
}, [wordMatches, website, phone, companyName, looksGovernmental, siteVerification]);
  ...
  <section className="relative overflow-hidden border-y border-[#d6e3ee] bg-gradient-to-br from-[#16324f] via-[#1e4f78] to-[#0f766e] text-white print:hidden">
    ...
    <div className="relative mx-auto max-w-7xl px-6 py-20">
      ...
      <p className="mt-6 max-w-3xl text-lg leading-8 text-[#eaf4fb]">
        ...
        Paste a Medicare-related, life-insurance, auto-insurance, or other insurance
        ad aimed at older adults. You can also paste a mailer, text message, email,
        website, or phone script.

        This tool helps you check the words, visual presentation, sender, website,
  ...
  >
    ...
    <div className="rounded-[2rem] border border-[#d6e3ee] bg-white p-6 shadow-xl shadow-[#16324f]/5 sm:p-8">
      ...
      <p className="mt-3 text-base leading-7 text-[#526b80]">
        ...
        Paste words from an insurance ad, mailer, text, email, website, or phone call.
        If it was a commercial, briefly describe what the office, line, counter, workers,
        forms, or other visuals looked like.
      ...
      <textarea
        ...
        placeholder="Example: The commercial said ‘state-approved benefit’ and ‘call by Friday.’ People were standing in a benefits line at an office that looked governmental..."
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          ...
          {[
...

            {
              ...
              label: "Did the setting look like a government, Social Security, or benefits office?",

              value: looksGovernmental,

              setter: setLooksGovernmental,
